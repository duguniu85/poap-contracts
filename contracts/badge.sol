...
contract Badge is Initializable, ERC721, ERC721Enumerable, PoapRoles, PoapPausable {
    ...
    function initialize(string memory __name, string memory __symbol, string memory __baseURI)
    public initializer
    {
        ERC721.initialize();
